...
{
    [Binding]
    public class RequestForPartnershipSteps
    {
        ...
        public void GivenIHaveANotificationForPartnership()
        {
        ...
        public void WhenIAcceptTheRequest()
        {
            //ScenarioContext.Current.Pending();
        }

        [Then(@"the response is sent to the requesting company")]
        public void ThenTheResponseIsSentToTheRequestingCompany()
        {

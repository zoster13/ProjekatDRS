...
#line hidden
        ...
        [NUnit.Framework.TestCaseAttribute("\"luka\"", "\"lukic\"", new string[0])]
...
#line 17
 testRunner.Given("I have form to log in", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "Given ");
#line 18
 testRunner.When(string.Format("I enter wrong {0} or {1}", username, password), ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "When ");
#line 19
